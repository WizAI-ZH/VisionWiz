...
def MobileNet(input_shape=None,
    ...
    if weights == 'imagenet':
        ...
        if include_top:
            ...
            #                                     cache_subdir='models')
        try:
            model.load_weights(os.path.join(os.getcwd(),'maix_train/train/detector/weights',model_name))
        except:
...
def _depthwise_conv_block_without_same(inputs, pointwise_conv_filters, alpha,
                          depth_multiplier=1, strides=(1, 1), block_id=1):
