...
export class EditorContext extends BaseContext {
    public static actions: HotKeyAction[] = [
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "0"] : ["Control", "1"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "1"] : ["Control", "2"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "2"] : ["Control", "3"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "3"] : ["Control", "4"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "4"] : ["Control", "5"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "5"] : ["Control", "6"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "6"] : ["Control", "7"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "7"] : ["Control", "8"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "8"] : ["Control", "9"],
            action: (event: KeyboardEvent) => {
        ...
        {
            keyCombo: PlatformUtil.isMac(window.navigator.userAgent) ? ["Alt", "9"] : ["Control", "0"],
            action: (event: KeyboardEvent) => {
