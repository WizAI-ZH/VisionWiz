export enum Action {
    ...
    UPDATE_IMAGE_SORT_MODE = '@@UPDATE_IMAGE_SORT_MODE',
    PUSH_LABEL_HISTORY = '@@PUSH_LABEL_HISTORY',
    UNDO_LABEL_HISTORY = '@@UNDO_LABEL_HISTORY',
    REDO_LABEL_HISTORY = '@@REDO_LABEL_HISTORY',
